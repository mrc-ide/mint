<template>
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h1>Accessibility on MINT</h1>
                <p>This statement applies to content published on mint.dide.ic.ac.uk</p>
                ...
                <p>Imperial College London is committed to making its website accessible in accordance with the Public
