        ...
        <div class="results">
            ...
            <div v-if="strategies.length">
                ...
                <div v-if="selectedStrategy">
                    <h2 class="h4 text-center mt-5">Details for Strategy {{
                            strategies.indexOf(selectedStrategy) + 1
                        }}</h2>
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="text-success nav-link" :class="{active: activeTab === 'charts'}"
                               @click="activeTab = 'charts'">Charts</a>
                        </li>
                        <li class="nav-item">
                            <a class="text-success nav-link" :class="{active: activeTab === 'table'}"
                               @click="activeTab = 'table'">Table</a>
                        </li>
                    </ul>
