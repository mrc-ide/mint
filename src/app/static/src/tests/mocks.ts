...
export function mockProject(name = "project 1", regions = ["region 1"], strategies: StrategyWithThreshold[] = []): Project {
    return new Project(name, regions, {controlSections: []}, {controlSections: []}, null, strategies);
}
